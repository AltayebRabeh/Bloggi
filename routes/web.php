...
Route::group(['middleware' => 'verified'], function() {
    ...
    Route::any('user/notifications/get', 'Frontend\NotificationController@getNotifications');
    Route::any('user/notifications/read', 'Frontend\NotificationController@markAsRead');
    Route::any('user/notifications/read/{id}', 'Frontend\NotificationController@markAsReadAndRedirect');
...
Route::group(['prefix' => 'admin'], function() {
    ...
    Route::group(['middleware' => ['roles', 'role:admin|editor']], function() {
        ...
        Route::any('/notifications/get', 'Backend\NotificationController@getNotifications');
        Route::any('/notifications/read', 'Backend\NotificationController@markAsRead');
        Route::any('/notifications/read/{id}', 'Backend\NotificationController@markAsReadAndRedirect');


        Route::get('/',                     ['as' => 'admin.index',              'uses' => 'Backend\AdminController@index']);
        Route::get('/index',                ['as' => 'admin.index',              'uses' => 'Backend\AdminController@index']);

        Route::post('/posts/remove_image/{media_id}',   ['as' => 'admin.posts.media.destroy', 'uses' => 'Backend\PostsController@removeImage']);
        Route::resource('posts',            'Backend\PostsController',           ['as' => 'admin']);

        Route::post('/pages/remove_image/{media_id}',   ['as' => 'admin.pages.media.destroy', 'uses' => 'Backend\PagesController@removeImage']);
        ...
        Route::post('/users/remove_image',  ['as' => 'admin.users.remove_image', 'uses' => 'Backend\UsersController@removeImage']);
        Route::resource('users',            'Backend\UsersController',           ['as' => 'admin']);

        Route::post('/supervisors/remove_image',  ['as' => 'admin.supervisors.remove_image', 'uses' => 'Backend\SupervisorsController@removeImage']);
