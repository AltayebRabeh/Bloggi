        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        {!! Form::label('bio', 'Bio') !!}
                        {!! Form::textarea('bio', old('bio'), ['class' => 'form-control', 'style' => 'max-height: 100px']) !!}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('permissions[]', [] + $permissions->toArray(), old('permissions'), ['class' => 'form-control select-multiple-tag', 'multiple' => 'multiple']) !!}
