            ...
            <div class="col-lg-8 d-none d-lg-block">
                <nav class="mainmenu__nav">
                    <ul class="meninmenu d-flex justify-content-start">
                        ...
                        <li class="drop"><a href="javascriopt:void(0)">Blog</a>
            ...
            <div class="col-lg-12 d-none">
                <nav class="mobilemenu__nav">
                    <ul class="meninmenu">
                        ...
                        <li><a href="{{ route('post.show', 'about-us') }}">Aboute Us</a></li>
                        <li><a href="{{ route('post.show', 'our-vision') }}">Aboute Vision</a></li>
