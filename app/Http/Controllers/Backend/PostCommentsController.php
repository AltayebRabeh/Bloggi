...
class PostCommentsController extends Controller
{
    ...
    {
        if (! \auth()->user()->ability('admin', 'manage.post_comments,show.post_comments')) {
    ...
    {
        if (! \auth()->user()->ability('admin', 'update.post_comments')) {
            return redirect('admin/index');
        }
    ...
    {
        if (! \auth()->user()->ability('admin', 'delete.post_comments')) {
            return redirect('admin/index');
        }
        $comment = Comment::whereId($id)->first();
